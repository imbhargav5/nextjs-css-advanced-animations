  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-8 bg-white">
      <div className="max-w-4xl w-full space-y-8">
        <h2 className="text-3xl font-bold text-center mb-8">Overlay Blend</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Example 1: Basic overlay */}
          <div className="space-y-4">
            <h3 className="text-xl font-semibold">Basic Overlay</h3>
          ...
          {/* Example 2: Overlay with contrasting colors */}
          <div className="space-y-4">
          ...
          {/* Example 3: Overlay circles */}
          <div className="space-y-4">
            <h3 className="text-xl font-semibold">Overlay Circles</h3>
            <div className="bg-white p-6 rounded-lg shadow-lg">
          ...
          {/* Example 4: Overlay rectangles */}
          <div className="space-y-4">
            <h3 className="text-xl font-semibold">Overlay Rectangles</h3>
            <div className="bg-white p-6 rounded-lg shadow-lg">
...
/* Darkens if base color is dark, lightens if base color is light */`}</code>
          </pre>
        </div>
      </div>
    </div>
