...
export function ExclusionBlendDemo() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-8 bg-white">
      <div className="max-w-4xl w-full space-y-8">
        <h2 className="text-3xl font-bold text-center mb-8">Exclusion Blend</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Example 1: Basic exclusion */}
          <div className="space-y-4">
            <h3 className="text-xl font-semibold">Basic Exclusion</h3>
          ...
          {/* Example 2: Exclusion with contrasting colors */}
          <div className="space-y-4">
          ...
          {/* Example 3: Exclusion circles */}
          <div className="space-y-4">
            <h3 className="text-xl font-semibold">Exclusion Circles</h3>
            <div className="bg-white p-6 rounded-lg shadow-lg">
          ...
          {/* Example 4: Exclusion rectangles */}
          <div className="space-y-4">
            <h3 className="text-xl font-semibold">Exclusion Rectangles</h3>
            <div className="bg-white p-6 rounded-lg shadow-lg">
        ...
        <div className="mt-8 bg-white p-6 rounded-lg shadow-lg">
          ...
          <pre className="bg-gray-100 p-4 rounded overflow-x-auto">
            <code>{`mix-blend-mode: exclusion;
/* Similar to difference but with lower contrast */
/* Creates softer inversion effects */`}</code>
          </pre>
        </div>
      </div>
    </div>
