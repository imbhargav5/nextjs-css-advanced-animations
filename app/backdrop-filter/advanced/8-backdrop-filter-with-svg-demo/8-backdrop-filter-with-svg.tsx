...
export function BackdropFilterWithSVGDemo() {
  return (
    <div className="max-w-6xl mx-auto space-y-8">
      <h2 className="text-3xl font-bold mb-8">Backdrop Filter with SVG</h2>

      <DemoBlock
        title="SVG Background Pattern"
...
backdrop-filter: blur(15px);`}
  ...
  <div
    ...
    style={{
      ...
      maskImage: \`url("data:image/svg+xml,%3Csvg...%3E%3Ccircle.../  %3E%3C/svg%3E")\`,
      WebkitMaskImage: \`url("data:image/svg+xml,%3Csvg...%3E%3Ccircle.../%3E%3C/svg%3E")\`
    }}
  />
</div>
...
mask-image: url("data:image/svg+xml,...");`}
  ...
  <div
    className="absolute inset-0 bg-white/30 rounded-lg"
    style={{ backdropFilter: "blur(15px) saturate(1.5)" }}
  />
</div>
