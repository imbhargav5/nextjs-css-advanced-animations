  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-8 bg-gray-50">
      <div className="max-w-4xl w-full space-y-8">
        <h2 className="text-3xl font-bold text-center mb-8 text-gray-900">Grayscale Backdrop Filter</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Example 1: Partial grayscale */}
          <div className="space-y-4">
            <h3 className="text-xl font-semibold text-gray-900">Partial Grayscale (0.5)</h3>
          ...
          {/* Example 2: Full grayscale */}
          <div className="space-y-4">
            <h3 className="text-xl font-semibold text-gray-900">Full Grayscale (1.0)</h3>
            <div className="relative p-6 rounded-lg shadow-lg">
          ...
          {/* Example 3: Light grayscale */}
          <div className="space-y-4">
            <h3 className="text-xl font-semibold text-gray-900">Light Grayscale (0.3)</h3>
            <div className="relative p-6 rounded-lg shadow-lg">
          ...
          {/* Example 4: Strong grayscale */}
          <div className="space-y-4">
            <h3 className="text-xl font-semibold text-gray-900">Strong Grayscale (0.8)</h3>
            <div className="relative p-6 rounded-lg shadow-lg">
        ...
        <div className="mt-8 bg-white/90 backdrop-blur-sm p-6 rounded-lg shadow-lg">
          ...
          <pre className="bg-gray-100 p-4 rounded overflow-x-auto">
            <code>{`backdrop-filter: grayscale(1.0);
/* Values: 0 (no effect) to 1 (fully grayscale) */
/* Converts the background to grayscale */`}</code>
          </pre>
        </div>
      </div>
    </div>
