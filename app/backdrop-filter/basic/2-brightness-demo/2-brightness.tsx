  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-8 bg-gray-50">
      <div className="max-w-4xl w-full space-y-8">
        <h2 className="text-3xl font-bold text-center mb-8 text-gray-900">Brightness Backdrop Filter</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Example 1: Darker */}
          <div className="space-y-4">
            <h3 className="text-xl font-semibold text-gray-900">Darker (0.5)</h3>
          ...
          {/* Example 2: Brighter */}
          <div className="space-y-4">
            <h3 className="text-xl font-semibold text-gray-900">Brighter (1.5)</h3>
            <div className="relative p-6 rounded-lg shadow-lg">
          ...
          {/* Example 3: Much darker */}
          <div className="space-y-4">
            <h3 className="text-xl font-semibold text-gray-900">Much Darker (0.3)</h3>
            <div className="relative p-6 rounded-lg shadow-lg">
          ...
          {/* Example 4: Very bright */}
          <div className="space-y-4">
            <h3 className="text-xl font-semibold text-gray-900">Very Bright (2.0)</h3>
            <div className="relative p-6 rounded-lg shadow-lg">
        ...
        <div className="mt-8 bg-white/90 backdrop-blur-sm p-6 rounded-lg shadow-lg">
          ...
          <pre className="bg-gray-100 p-4 rounded overflow-x-auto">
            <code>{`backdrop-filter: brightness(1.5);
/* Values: 0-1 (darker), 1 (normal), >1 (brighter) */
/* Adjusts the brightness of the background behind the element */`}</code>
          </pre>
        </div>
      </div>
    </div>
